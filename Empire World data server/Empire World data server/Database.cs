...
namespace dataserver
{
    public class Database : IDisposable
    {
        ...
        {
            con = new MySqlConnection("Server=127.0.0.1;Database=rotmg;uid=empireworld;password=botmaker;Allow Zero Datetime=true"); //later will read from a registry value maybe
            con.Open();
        }
