        ...
        static _ LostLands = Behav()
            .Init(0x0d50, Behaves("Lord of the Lost Lands",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                            ...
                            Tuple.Create(0.25, (ILoot)new ItemLoot("Shield of Ogmur")),
                            Tuple.Create(0.15, (ILoot)new ItemLoot("Orb of the Chaos Walker")),

                            Tuple.Create(0.5, (ILoot)new TierLoot(8, ItemType.Armor)),
                            Tuple.Create(0.5, (ILoot)new TierLoot(9, ItemType.Armor)),
                            ...
                            Tuple.Create(0.5, (ILoot)new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(0.5, (ILoot)new TierLoot(9, ItemType.Weapon)),
