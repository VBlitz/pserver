        ...
        static _ Mountain = Behav()
            ...
            .Init(0x657, Behaves("Flying Brain",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(1, CommonGodSoulBag),
                        Tuple.Create(360, new LootDef(0, 1, 0, 8,
                            Tuple.Create(PotProbability, (ILoot)new StatPotionLoot(StatPotion.Wis))
                        ))
                    )
                ))
            ...
            .Init(0x1970, Behaves("Sulthos the Snake Lord",
                ...
                .Init(0x2004, Behaves("Thunder God",
                    new RunBehaviors(
                        ...
                        Chasing.Instance(4, 6, 5, null),
                        new QueuedBehavior(
                            Cooldown.Instance(2000, PredictiveMultiAttack.Instance(6, 20 * (float)Math.PI / 180, 3, 0.4f, 0)),
                            Cooldown.Instance(2000, MultiAttack.Instance(6, 20 * (float)Math.PI / 180, 3))
                        )
                    ),
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(1, CommonGodSoulBag),
                        Tuple.Create(360, new LootDef(0, 1, 0, 8,
                            Tuple.Create(PotProbability, (ILoot)new StatPotionLoot(StatPotion.Att)),
                            Tuple.Create(0.0025, (ILoot)new ItemLoot("Scepter of Thunderclash"))
                        ))
                    )
                ));
    }
