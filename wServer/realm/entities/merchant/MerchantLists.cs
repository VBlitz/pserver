...
//Potions
{0xa1f, new Tuple<int,CurrencyType>(30, CurrencyType.Fame)}, //Attack
{0xa20, new Tuple<int,CurrencyType>(60, CurrencyType.Fame)}, //Defense
{0xa21, new Tuple<int,CurrencyType>(15, CurrencyType.Fame)}, //Speed
{0xa34, new Tuple<int,CurrencyType>(75, CurrencyType.Fame)}, //Vitality
{0xa35, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Wisdom
{0xa4c, new Tuple<int,CurrencyType>(25, CurrencyType.Fame)}, //Dexterity
{0xae9, new Tuple<int,CurrencyType>(250, CurrencyType.Fame)}, //Life
{0xaea, new Tuple<int,CurrencyType>(125, CurrencyType.Fame)}, //Mana
...
{0x1130, new Tuple<int,CurrencyType>(20, CurrencyType.Fame)}, //Gold
      ...
      /*  public static int[] store1List = { 0x701, 0x705, 0x706, 0x70a, 0x70b, 0x710, 0x71f, 0x722, 0xc11, 0xc19, 0xc23, 0xc2e, 0xc3d }; //keys */
        ...
        public static int[] store5List = { 0xa1f, 0xa20, 0xa21, 0xa34, 0xa35, 0xa4c, 0xae9, 0xaea }; //Consumables
